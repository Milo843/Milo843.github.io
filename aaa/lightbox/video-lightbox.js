...
function openModal() {
    document.getElementById("lightbox-CGI-main").style.display = "block";
    document.documentElement.requestFullscreen();
    document.body.style.overflow = 'hidden';
}
//Close Lightbox; Exit FullScreen; Show Scrollbar
function closeModal() {
    document.getElementById("lightbox-CGI-main").style.display = "none";
...
function showSlides(n) {
    var i;
    var slides = document.querySelectorAll('#lightbox-CGI-main picture, #lightbox-CGI-main video');
